(function () {
    ...
    angular.module('petModeAdminApp')
        .controller('AdminCopulationSlidesController', ['$scope', '$state', 'ngDialog', 'CopulationSlidesFactory', '$stateParams', function ($scope, $state, ngDialog, slides, $stateParams) {

            if($state.current.name == 'copulation_slides'){
                $scope.slides = [];
            ...
            if($state.current.name == 'new_copulation_slide'){
