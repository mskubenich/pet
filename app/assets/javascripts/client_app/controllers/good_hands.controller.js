(function () {
    ...
    angular.module('petModeApp')
        .controller('GoodHandsController', ['$scope', '$state', 'ngDialog', 'GoodHandsFactory', '$stateParams', '$timeout', '$sce', 'Lightbox',
            function ($scope, $state, ngDialog, good_hands, $stateParams, $timeout, $sce, Lightbox) {
            $scope.I18n = I18n;
            $scope._ = _;
