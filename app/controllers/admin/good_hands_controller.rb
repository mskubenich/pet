class Admin::GoodHandsController < AdminController
  ...
  def hand_params
    params.require(:announcement).permit(:family, :name, :age, :breed_id, :scorp, :rkf, :description, :photos, :prize, :bloodline, :mothers_photo, :fathers_photo, :sex, :country_id, :city, :color, :weight)
  end
end